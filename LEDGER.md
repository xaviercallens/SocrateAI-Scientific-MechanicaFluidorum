...
`(−1)² = 1`), gives `O(3 × triads)` — a factor `classes/3` = **2846** at `M = 16`, 22844 at
...
eigenvalue, i.e. `ν₁^odd = 1/12`, `μ₂ = 1/6`, gap → exactly 5/6. Six-point Tier C support
