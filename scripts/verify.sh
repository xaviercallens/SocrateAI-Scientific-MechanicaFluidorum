...
FAILED=0
for f in LocalDualScale DyadicShells DyadicShell_Statements EnstrophyProduction EnstrophyProductionBound MillenniumReduction AbstractAlgebraicConservation TriadTorus DyadicRiccati FourierStateZ3 FourierDynamicsZ3; do
