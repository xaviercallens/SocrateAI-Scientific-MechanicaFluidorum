...
for h in tests/tier_b_exact_checks.py tests/tier_b_dyadic_checks.py tests/tier_b_enstrophy_production.py tests/tier_b_production_bound.py tests/test_percolation.py tests/tier_b_nse_triad_convolution.py tests/tier_b_grid_adequacy.py; do
  echo "-- $h"
