...
for h in tests/tier_b_exact_checks.py tests/tier_b_dyadic_checks.py tests/test_percolation.py; do
  echo "-- $h"
...
FAILED=0
for f in CallensDualScale DyadicShells HypothesisU_Statements; do
