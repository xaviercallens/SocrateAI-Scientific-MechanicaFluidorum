...
for h in tests/controls.py tests/tier_b_exact_checks.py tests/tier_b_dyadic_checks.py tests/tier_b_enstrophy_production.py tests/tier_b_production_bound.py tests/test_percolation.py tests/tier_b_nse_triad_convolution.py tests/tier_b_grid_adequacy.py tests/tier_b_regime_adequacy.py tests/tier_b_ball_2section.py tests/tier_b_riccati_exponents.py tests/tier_b_quartic_invariants.py tests/tier_b_helical_resonance.py tests/tier_b_helical_closed_form.py tests/tier_b_helical_gauge.py tests/tier_b_weighted_triad.py tests/tier_b_fourier_enstrophy.py tests/tier_b_helical_production_expansion.py tests/tier_b_production_cancellation.py tests/tier_b_director_stratum.py tests/tier_b_adversarial_alignment.py tests/tier_b_dynamic_access.py tests/tier_b_core_forcing_bound.py; do
  echo "-- $h"
...
FAILED=0
for f in LocalDualScale DyadicShells DyadicShell_Statements EnstrophyProduction EnstrophyProductionBound MillenniumReduction AbstractAlgebraicConservation TriadTorus DyadicRiccati FourierStateZ3 FourierDynamicsZ3 HelicalBasis; do
