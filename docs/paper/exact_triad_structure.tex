...
\author{Socrate AI Lab}
\address{Socrate AI Lab, a non-profit organisation for neuro-symbolic scientific AI}
\date{\today}
...
Problem~\ref{prob:56} are in the public repository cited below, archived at the release this
paper accompanies.\footnote{\url{https://github.com/xaviercallens/SocrateAI-Scientific-MechanicaFluidorum},
release \texttt{v1.9.0}; archived snapshot: \href{https://doi.org/10.5281/zenodo.22823607}{\texttt{doi:10.5281/zenodo.22823607}}.}
The correspondence between statements and formal names is:
